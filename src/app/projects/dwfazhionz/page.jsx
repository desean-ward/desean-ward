      ...
      <MainContent>
        <div className='col-span-4'>
          ...
          <p>
            ...
            Users are able to search clothing categories, view a product&#039;s
            description, add items to a shopping bag, and checkout with credit
            card information via the Stripe API. User authentication is
            available, so you can signup & signin to your account with an email
            address; or Google account. Product descriptions were made possible
            with the embedded OpenAI API. Newsletter signup and contact form
            functionality are powered by EmailJS.
          </p>
          ...
          {/**
					 ...
					 */}
          <Link href='https://dw-fazhionz.netlify.app/' target={"_blank"}>
