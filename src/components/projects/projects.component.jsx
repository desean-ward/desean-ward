...
const Projects = () => {
  ...
  return (
    <ProjectsContainer id='projects' className=''>
      <ProjectsHeader variants={slideUp} initial='initial' animate='animate'>
      ...
      <ProjectsContentWrapper>
        ...
        >
          ...
          <ProjectItem
            ...
            img={dwFazhionz}
            title='D.W. Fazhionz!'
            text='A mock fashion e-Commerce website built with React and Firebase.'
          ...
          <ProjectItem
            ...
            text='A mock real estate website built with the MERN stack.'
