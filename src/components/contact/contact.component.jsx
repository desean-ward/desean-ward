                    ...
                    {/* left side */}
                        <div className='col-span-3 lg:col-span-2 h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
                            <div className='lg:p-4 h-full'>
                                <div>
                                    <Image className='w-full rounded-xl hover:scale-105 ease-in duration-300' width='300' src={contact} alt='/' />
                                </div>

                                <div>
                                    <h2 className='py-2 text-[tan] text-shadow-lg shadow-gray-900'>De Sean Ward</h2>
